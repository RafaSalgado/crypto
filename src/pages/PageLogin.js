      ...
      <form name="sentMessage" id="contactForm" noValidate="novalidate" onSubmit={this.handleSubmit.bind(this)} >
        <div className="control-group">
          <div className="form-group floating-label-form-group controls mb-0 pb-2 text-center">
            ...
            <input className="form-control text-center" type="text" value={this.state.id} placeholder="usuario" onChange={this.handleIdChange.bind(this)} required/>
        ...
        <div className="control-group">
          <div className="form-group floating-label-form-group controls mb-0 pb-2 text-center">
            ...
            <input className="form-control text-center" type="password" value={this.state.pass} placeholder="Contraseña" onChange={this.handlePassChange.bind(this)} required />
